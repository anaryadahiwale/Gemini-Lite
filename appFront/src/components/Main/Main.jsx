...
const Main = () => {
  const { onSent, recentPrompt, showResult, loading, resultData, setInput, input, darkMode } = useContext(Context); // Include darkMode

  return (
    <div className={`main ${darkMode ? "dark" : ""}`}> {/* Apply dark mode class */}
      <div className="nav">
        <p>Gemini</p>
